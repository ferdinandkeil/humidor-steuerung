...
void lcd_number( uint16_t number, uint8_t len, uint8_t fill ) {
    uint8_t digit1 = 0;
    uint8_t digit2 = 0;
	uint8_t digit3 = 0;
	uint8_t digit4 = 0;
	...
	if (len > 4) lcd_data( (digit1 != 0) ? digit1+'0' : fill );
	if (len > 3) lcd_data( (digit2 != 0) ? digit2+'0' : fill );
    if (len > 2) lcd_data( (digit3 != 0) ? digit3+'0' : fill );
    if (len > 1) lcd_data( (digit4 != 0) ? digit4+'0' : fill );
    lcd_data( number+'0' );
}
