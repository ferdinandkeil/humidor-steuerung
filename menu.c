...
const char MENU_STR_VER[] PROGMEM =            "Firmware-Ver.";
...
const Menu_State_t Menu_state[] PROGMEM = {
	...
	{MENU_STATE_VER_SHOW, Menu_Version},
...
const Menu_NextState_t Menu_nextState[] PROGMEM = {
	...
	{MENU_STATE_TIME  ,  MENU_INPUT_DOWN,  MENU_STATE_VER     },

	{MENU_STATE_VER   ,  MENU_INPUT_UP  ,  MENU_STATE_TIME    },
	{MENU_STATE_VER   ,  MENU_INPUT_PUSH,  MENU_STATE_VER_SHOW},
	{MENU_STATE_VER   ,  MENU_INPUT_DOWN,  MENU_STATE_BACK    },

	{MENU_STATE_BACK  ,  MENU_INPUT_UP  ,  MENU_STATE_VER     },
	...
	{MENU_STATE_VER_SHOW, MENU_INPUT_PUSH, MENU_STATE_VER},
